...
const Quizzes = () => {
  const { data: quizzes, isLoading } = useGetQuizzessQuery();
  ...
  useEffect(() => {
    deleteSuccess && toast.success("Quizzes Deleted Successfully");
    isError && toast.warn("Quizzes Deleting Failed");
        ...
        <div className="px-3 bg-opacity-10">
          ...
          <div className="flex justify-end">
            <div className="flex">
              <button
                className="btn mr-2"
                onClick={() => navigate("/admin/add-quizzes")}
              >
                Add Quiz
              </button>
